...
const routes = [
  { path: '/login', name: 'Login', component: () => import('@/views/login/LoginView.vue') },
  {
    ...
    children: [
      ...
      { path: 'edu/grade-status', name: 'GradeStatus', component: () => import('@/views/edu/GradeStatus.vue') },
      ...
      { path: 'message/group', name: 'GroupChat', component: () => import('@/views/message/GroupChat.vue') },
      ...
      { path: 'manage/schedule', name: 'ScheduleManage', component: () => import('@/views/manage/ScheduleManage.vue') },
